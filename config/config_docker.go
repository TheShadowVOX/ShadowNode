...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"shadownode_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"shadownode_nw" yaml:"network_mode"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the shadownode containers are started with user namespace
	// remapping disabled
