...
import (
	...
	"github.com/TheShadowVOX/shadownode/internal/models"
	"github.com/TheShadowVOX/shadownode/router/downloader"
	"github.com/TheShadowVOX/shadownode/router/middleware"
	"github.com/TheShadowVOX/shadownode/router/tokens"
...
func getServerFileContents(c *gin.Context) {
	...
	//
	// @see https://github.com/shadownode/panel/issues/4059
	...
	//
	// @see https://github.com/shadownode/panel/issues/3131
...
func postServerDecompressFiles(c *gin.Context) {
	...
	if err != nil {
		if filesystem.IsErrorCode(err, filesystem.ErrCodeUnknownArchive) {
			...
			c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"error": "The archive provided is in a format ShadowNode does not understand."})
			return
		}
		middleware.CaptureAndAbort(c, err)
		return
