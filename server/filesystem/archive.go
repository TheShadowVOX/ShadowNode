...
import (
	...
	"github.com/TheShadowVOX/shadownode/internal/progress"
	"github.com/TheShadowVOX/shadownode/internal/ufs"
)
...
func (a *Archive) callback(opts ...walkFunc) walkFunc {
	...
	return func(dirfd int, name, relative string, d ufs.DirEntry) error {
		...
		//
		// See https://github.com/shadownode/panel/issues/5030 for more details.
		if base != "" {
